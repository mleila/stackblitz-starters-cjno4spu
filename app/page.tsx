  ...
  return (
    <main className="min-h-screen bg-black text-white overflow-x-hidden">
          ...
          <div className="max-w-5xl mx-auto text-center">
            <div className="opacity-0 animate-[fadeInUp_1s_ease-out_forwards]">
              <h1 className="text-5xl md:text-7xl lg:text-8xl font-black mb-6 leading-tight">
                <span className="bg-gradient-to-r from-white via-red-200 to-white bg-clip-text text-transparent bg-[length:200%_200%] animate-[gradient_3s_ease_infinite]">
                  Injured in a
                </span>
                <br />
                <span className="text-red-500 animate-[pulseSlow_2s_ease-in-out_infinite]">Car Accident?</span>
              </h1>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center opacity-0 animate-[fadeInUp_1s_ease-out_0.4s_forwards]">
              <button
            ...
            <div className="mt-8 flex flex-wrap justify-center gap-6 text-sm opacity-0 animate-[fadeInUp_1s_ease-out_0.6s_forwards]">
              ...
              >
                <div className="bg-gradient-to-br from-slate-900 to-slate-800 p-8 rounded-2xl border border-slate-700 hover:border-red-500 transition-all hover:shadow-2xl hover:shadow-red-500/20">
                  <div className="flex mb-4">
                    {[...Array(5)].map((_, i) => (
                      <span key={i} className="text-yellow-500 text-xl animate-[pulseSlow_2s_ease-in-out_infinite]" style={{ animationDelay: `${i * 0.1}s` }}>
                        ★
                      </span>
                    ))}
                  </div>
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <div className="text-2xl font-black text-green-500 animate-[pulseSlow_2s_ease-in-out_infinite]">
                      {testimonial.amount}
                    </div>
                  </div>
                </div>
      ...
      <section className="relative py-24 overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-r from-red-900 via-red-800 to-red-900 bg-[length:200%_100%] animate-[gradientX_20s_ease_infinite]" />
        <div className="absolute inset-0 bg-black/50" />
        
        <div className="container mx-auto px-4 relative z-10 text-center">
          <h2 className="text-4xl md:text-6xl font-black mb-6 opacity-0 animate-[fadeInUp_1s_ease-out_forwards]">
            Don&apos;t Wait - Evidence Disappears Fast
          </h2>
          <p className="text-xl md:text-2xl mb-10 max-w-3xl mx-auto opacity-0 animate-[fadeInUp_1s_ease-out_0.2s_forwards]">
          ...
          {/* Urgency Indicators */}
          <div className="mt-12 flex justify-center gap-8 opacity-0 animate-[fadeInUp_1s_ease-out_0.6s_forwards]">
      ...
      {showForm && (
        <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4 opacity-0 animate-[fadeIn_0.3s_ease-out_forwards]">
          <div className="bg-gradient-to-br from-slate-900/90 to-slate-800/90 backdrop-blur-xl rounded-3xl max-w-md w-full p-8 relative border border-slate-700 shadow-2xl opacity-0 animate-[scaleIn_0.3s_ease-out_forwards]">
            <button
